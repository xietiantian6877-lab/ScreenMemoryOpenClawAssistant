...
contextBridge.exposeInMainWorld("screenMemory", {
  ...
  getModelGroupDetail: (id) => ipcRenderer.invoke("modelGroups:detail", id),
  saveModelGroup: (group) => ipcRenderer.invoke("modelGroups:save", group),
  ...
  listModels: (force, groupId) => ipcRenderer.invoke("models:list", force, groupId),
